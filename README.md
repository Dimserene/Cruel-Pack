...
## How to Install
  ...
  Download __SetupCruel.bat__(Windows) or __SetupCruel.sh__(Linux), put it wherever you want, and run it. The mods will be automatically downloaded and put into correct directory.
...
## How to Update Modpack
  ...
  Run __UpdateCruel.bat__(Windows) or __UpdateCruel.sh__(Linux) which should be in the downloaded __Cruel-Pack__ folder.
